...
const EditStudent: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                // Fetch classes and student data in parallel
                const [classesData, studentData] = await Promise.all([
                    classService.getAll(),
                ...
                if (studentData) {
                    const { enrollmentHistory: history, attendanceRecords, id: studentIdNum, ...restOfStudentData } = studentData;
